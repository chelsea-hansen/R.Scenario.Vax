...
**R.Scenario.Vax** is an **R** package designed to provide **S**cenario projections for **RSV** hospitalizations in the context of new **V**accines and immunizations.
...
* Infants are born into the “M” compartment with partial protection against infection. As this protection wanes, they transition to the “S0” compartment until they experience their first infection, “I1”.
...
|<sup>1</sup>Duration of maternal immunity (1/&omega;<sub>1</sub>)|90 days|
...
|Duration of infant immunizations after maternal protection wanes (1/&omega;<sub>i</sub>)|90 days|
|Vaccine effectiveness in older adults |80%|
|Duration of vaccine effectiveness in older adults (1/&omega;<sub>v</sub>)|2 years|
...
plot1 = ggplot(data=timeseries)+
  theme_bw()+
  geom_line(aes(x=date, y=value))+
  facet_wrap(~state,ncol=1,scales="free")+
  labs(x="Date", y="RSV Hospitalizations",title ="timeseries dataset")

plot2  = ggplot(data=age_distribution)+
  theme_bw()+
  geom_bar(aes(y=age_group,x=proportion),stat="identity")+
  facet_wrap(~state,ncol=1,scales="free")+
  labs(y="Age Group", x="Proportion", title="age_distribution dataset")
...
```{r commonerrors, warning=FALSE, error=TRUE}
